...
Эти функции обратного вызова будут исполнены когда вы запустите ваше приложение,
...
## <a name="application-event"></a> События иницализации приложения
...
## <a name="the-application-channel"></a> Система обмена сообщениями
...
### <a name="accessing-the-application-channel"></a> Доступ к системе обмена сообщениями
...
## <a name="regions-and-the-application-object"></a> Регионы и объект приложения
...
### <a name="custom-region-class"></a> Собственный тип региона
...
### <a name="custom-region-class-and-selector"></a> Собственный тип региона и селектор
...
### <a name="region-options"></a> Регионы как параметры
...
### <a name="overriding-the-default-regionmanager"></a> Переопределение стандартного `RegionManager`-а
...
### <a name="applicationgetoption"></a> Метод Application.getOption
