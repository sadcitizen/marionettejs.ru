...
Marionette.js имеет базовый тип `Marionette.View`, от которого наследуются другие преставления.
Этот тип предоставляет некоторую базовую функциональность, которая будут использовать наследующие представления.
...
Marionette.View наследуется от `Backbone.View`. Рекомендуется использовать метод `listenTo` для 
биндинга модели, коллекции или других событий от объектов Backbone.js и Marionette.js.
