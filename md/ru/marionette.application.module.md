...
Модули могут быть запущены и остановлены независимо от приложения и друг друга. Это 
дает нам возможность запускать их асинхронно и останавливать, если дальнейшая их работа нам не требуется.
